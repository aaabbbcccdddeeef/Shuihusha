    ...
    :CardPackage("purgatory")
{
    ...
    cards
            << new ChaosJink(Card::Heart, 3)
            << new ChaosJink(Card::Heart, 5)
            << new ChaosJink(Card::Heart, 8)
            << new ChaosJink(Card::Heart, 9)
            << new ChaosSlash(Card::Spade, 1)
            << new ChaosSlash(Card::Spade, 11)
            << new ChaosSlash(Card::Spade, 12)
            << new ChaosSlash(Card::Club, 2)
            << new ChaosSlash(Card::Club, 12)
            << new ChaosSlash(Card::Club, 13)
            << new ChaosSlash(Card::Diamond, 3)
            << new ChaosJink(Card::Diamond, 6)
            << new ChaosJink(Card::Diamond, 7)
            << new ChaosSlash(Card::Diamond, 8)
