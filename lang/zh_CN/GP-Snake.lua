...
return {
	...
	["hunyuan"] = "混元",
	[":hunyuan"] = "你每受到1点伤害或回复1点体力，可以亮出牌堆顶的一张牌，然后将其置于你的武将牌上，称为“熵”；在任意角色的判定牌生效前，你可以用一张“熵”替换之（“悟道”发动后，则代替之）。",
	["wudao"] = "悟道",
	...
	["fangzao"] = "仿造",
	[":fangzao"] = "出牌阶段，你可以展示任一其他角色的一张手牌：若该牌为基本牌或非延时类锦囊，则你于此阶段内可以将你的任一手牌当该牌使用（限一次）。每阶段限一次。",
	["jiangxin"] = "匠心",
